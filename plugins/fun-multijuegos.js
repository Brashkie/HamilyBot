...
{index: 1, urlButton: {displayText: '𝗛𝗮𝗺𝗶𝗹𝘆𝗕𝗼𝘁', url: 'https://github.com/Brashkie/HamilyBot'}},
{index: 2, urlButton: {displayText: '𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺', url: 'https://www.instagram.com/moisesyaurivilcacenteno/'}},
{index: 3, quickReplyButton: {displayText: '𝗜𝗻𝗶𝗰𝗶𝗮𝗿 | 𝗦𝘁𝗮𝗿𝘁', id: '.juegos'}},
{index: 4, quickReplyButton: {displayText: '𝗠𝗲𝗻𝘂 𝗷𝘂𝗲𝗴𝗼𝘀 | 𝗚𝗮𝗺𝗲𝘀 𝗺𝗲𝗻𝘂', id: '#juegosmenu'}},
{index: 5, quickReplyButton: {displayText: '𝗩𝗼𝗹𝘃𝗲𝗿 𝗮𝗹 𝗺𝗲𝗻𝘂 | 𝗕𝗮𝗰𝗸 𝘁𝗼 𝗺𝗲𝗻𝘂', id: '#menu'}},
]
  ...
  if (command == 'juegos') { 
    ...
    let gata = `${pickRandom([`𝙋𝙪𝙚𝙙𝙚𝙨 𝙂𝙖𝙣𝙖𝙧 𝘿𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨 𝙖𝙡 𝙅𝙪𝙜𝙖𝙧!!`,`𝙎𝙞𝙜𝙪𝙚 𝙟𝙪𝙜𝙖𝙣𝙙𝙤 𝙥𝙖𝙧𝙖 𝙜𝙖𝙣𝙖𝙧 𝙂𝙖𝙩𝙖𝘾𝙤𝙞𝙣𝙨!!`,`𝙎𝙖𝙗𝙞𝙖𝙨 𝙦𝙪𝙚 𝙥𝙪𝙚𝙙𝙚𝙨 𝙂𝙖𝙣𝙖𝙧 𝙀𝙭𝙥𝙚𝙧𝙞𝙚𝙣𝙘𝙞𝙖 𝙖𝙡 𝙅𝙪𝙜𝙖𝙧? 𝘼𝙝𝙤𝙧𝙖 𝙮𝙖 𝙡𝙤 𝙨𝙖𝙗𝙚𝙨!!`])}`
             let c = `${usedPrefix}`
              ...
              let ss = await `𖣐𝗛𝗮𝗺𝗶𝗹𝘆𝗕𝗼𝘁𖣐 | 𒅒𝔹𝕣𝕒𝕤𝕙𝕜𝕚𝕖 𝔻𝕚𝕠𝕤𒅒`

 const templateButtonsReplyMessage = [
{index: 1, urlButton: {displayText: '𖣐𝗛𝗮𝗺𝗶𝗹𝘆𝗕𝗼𝘁𖣐', url: 'https://github.com/GataNina-Li/GataBot-MD'}},
...
conn.sendMessage(m.chat, tt, m)
 ...
 if (command == 'juegos') {
   ...
   let gata = `${pickRandom([`𝘿𝙚𝙢𝙪𝙚𝙨𝙩𝙧𝙖 𝙦𝙪𝙚 𝙥𝙪𝙚𝙙𝙚𝙨 𝙡𝙡𝙚𝙜𝙖𝙧 𝙖𝙡 𝙏𝙤𝙥 1!!`,`𝙈𝙞𝙚𝙣𝙩𝙧𝙖𝙨 𝙢𝙖𝙨 𝙅𝙪𝙚𝙜𝙖𝙨 𝙩𝙪 𝙍𝙖𝙣𝙜𝙤 𝙩𝙖𝙢𝙗𝙞𝙚𝙣 𝙨𝙪𝙗𝙞𝙧𝙖!!`,`𝙋𝙖𝙧𝙩𝙞𝙘𝙞𝙥𝙖 𝙚𝙣 𝙚𝙡 𝙢𝙤𝙙𝙤 𝙈𝙪𝙡𝙩𝙞𝙟𝙪𝙚𝙜𝙤𝙨 𝙮 𝙂𝙖𝙣𝙖 𝙧𝙚𝙘𝙤𝙢𝙥𝙚𝙣𝙨𝙖𝙨!!`])}`
           ...
           let sss = await `𖣐𝗛𝗮𝗺𝗶𝗹𝘆𝗕𝗼𝘁𖣐 | 𒅒𝔹𝕣𝕒𝕤𝕙𝕜𝕚𝕖 𝔻𝕚𝕠𝕤𒅒`
...
conn.sendMessage(m.chat, ttt, m)
  ...
  if (command == 'juegos') { 
    ...
    let gata = `${pickRandom([`𝙀𝙡𝙞𝙟𝙚 𝙏𝙪 𝙀𝙢𝙤𝙟𝙞 𝙁𝙖𝙫𝙤𝙧𝙞𝙩𝙤 𝙥𝙖𝙧𝙖 𝙅𝙪𝙜𝙖𝙧!!`,`𝘼𝙙𝙞𝙫𝙞𝙣𝙖 𝙚𝙡 𝙋𝙧𝙤𝙭𝙞𝙢𝙤 𝙅𝙪𝙚𝙜𝙤!!`,`𝘼𝙙𝙞𝙫𝙞𝙣𝙖 𝙚𝙡 𝙋𝙧𝙤𝙭𝙞𝙢𝙤 𝙅𝙪𝙚𝙜𝙤!!`,`𝙈𝙞𝙣𝙞𝙟𝙪𝙚𝙜𝙤𝙨 𝙚𝙨𝙩á𝙣 𝙚𝙨𝙥𝙚𝙧𝙖𝙣𝙙𝙤 𝙚𝙣 𝙨𝙚𝙧 𝙅𝙪𝙜𝙖𝙙𝙤𝙨!!`])}`
                 ...
                 let ssss = await `𖣐𝗛𝗮𝗺𝗶𝗹𝘆𝗕𝗼𝘁𖣐 | 𒅒𝔹𝕣𝕒𝕤𝕙𝕜𝕚𝕖 𝔻𝕚𝕠𝕤𒅒`
