...
let handler = async (m, { conn, text }) => {
    ...
    m.reply('*𒆙El estado se ha subido exitosamente. Por favor, agrega el número del bot a tu lista de contactos y solicita al propietario del bot que te agregue a sus contactos para que puedas ver los estados.*')
    }
