...
let estado = `╭━━━━[ *E̷S̷T̷A̷D̷O̷ ̷|̷ ̷S̷T̷A̷T̷U̷S̷* ]━━━━━⬣
┃💗 *¡Hola | Hi!* ${name}
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ 
┃𓃠 *Versión de ${gt}*
┃➥ ${vs}
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃ღ ${global.opts['self'] ? 'ᴘʀɪᴠᴀᴅᴏ - ᴘʀɪᴠᴀᴛᴇ' : 'ᴘᴜʙʟɪᴄᴏ - ᴘᴜʙʟɪᴄ'}
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
/*let estado =`
╭━━━━[ *E̷S̷T̷A̷D̷O̷ ̷|̷ ̷S̷T̷A̷T̷U̷S̷* ]━━━━━⬣
┃💗 *¡Hola | Hi!* ${name}
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ 
┃𓃠 *Versión de ${gt}*
┃➥ ${vs}
...
handler.help = ['estado']
handler.tags = ['main']
handler.command = /^(estado|status|estate|state|heyhamily|stado|stats|botstat(us)?)$/i
