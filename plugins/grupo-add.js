...
if (text.includes('+')) throw  `${lenguajeGB['smsAvisoMG']()}𝐈𝐍𝐆𝐑𝐄𝐒𝐄 𝐄𝐋 𝐍𝐔𝐌𝐄𝐑𝐎 𝐓𝐎𝐃𝐎 𝐉𝐔𝐍𝐓𝐎 𝐒𝐈𝐍 𝐄𝐋 *+*\n𝐄𝐍𝐓𝐄𝐑 𝐓𝐇𝐄 𝐍𝐔𝐌𝐁𝐄𝐑 𝐀𝐋𝐋 𝐓𝐎𝐆𝐄𝐓𝐇𝐄𝐑 𝐖𝐈𝐓𝐇𝐎𝐔𝐓 𝐓𝐇𝐄 *+*`
let group = m.chat
let link = 'https://chat.whatsapp.com/' + await conn.groupInviteCode(group)
 
      await conn.reply(text+'@s.whatsapp.net', `¡Hola! Soy HamilyBot, un bot de WhatsApp. Un miembro del grupo intentó usò comando para agregarte al grupo, pero no tuve éxito. Te envío la invitación para que te unas al grupo. Esperamos verte pronto!!!\n\n${link}`, m, {mentions: [m.sender]})
