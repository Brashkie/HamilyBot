...
let msg = `${mg}ʟᴀ ꜰᴏʀᴍᴀ ᴅᴇ ᴜᴛɪʟɪᴢᴀʀ ᴇʟ ᴄᴏᴍᴀɴᴅᴏ ᴇꜱ ʟᴀ ꜱɪɢᴜɪᴇɴᴛᴇ\nᴇᴊᴇᴍᴘʟᴏ\n*${usedPrefix + command} (idioma) (texto)*\n*${usedPrefix + command} es Hola Brashkie Bot*\n\nᴛʜᴇ ᴡᴀʏ ᴛᴏ ᴜꜱᴇ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴀꜱ ꜰᴏʟʟᴏᴡꜱ\nᴇxᴀᴍᴘʟᴇ\n*${usedPrefix + command} (language) (text)*\n*${usedPrefix + command} en Hello Brashkie Bot*\n\n𝗜𝗗𝗜𝗢𝗠𝗔𝗦 𝗔𝗗𝗠𝗜𝗧𝗜𝗗𝗢𝗦 | 𝗦𝗨𝗣𝗣𝗢𝗥𝗧𝗘𝗗 𝗟𝗔𝗡𝗚𝗨𝗔𝗚𝗘𝗦\n*https://cloud.google.com/translate/docs/languages*`
