...
if wget -q https://github.com/Brashkie/HamilyBot/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/Brashkie/HamilyBot.git
...
echo -e "\033[01;32m\033[01mIniciando HamilyBot!!\nStarting HamilyBot!!\n\033[0m"
npm start
