...
const smsJBInfo2 = () => { return `💖 *The function is stable, if it presents any inconvenience Contact the mail: electronicatodo2006@gmail.com*\n💝 *You can make a voluntary donation by PayPal: ${global.paypal}*\n\n*Thank you very much for the support ${global.packname}*`}
...
const smsContacto4 = () => { return 'HamilyBot Official Contact 🐈'}
